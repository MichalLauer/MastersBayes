...
estimates or confidence intervals. Another approach, that is considered in this thesis, is the forecast of future
volatility. Because many popular techniques, such as the Black–Scholes model, assume homoskedasticity, it is only
natural to model the underlying volatility.