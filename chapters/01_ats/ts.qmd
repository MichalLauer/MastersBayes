...
strictly stationary process, it is often sufficient to have a weakly stationary process. \parencite[Def. 1.7]{ShumwayStoffer2017_TimeSeriesAnalysis}
...
series is strictly stationary, it is also weakly stationary. But the opposite is not true. Because of the hard
...
implies that the time series is not stationary and specific approach must be considered. Heteroskedasticity is also
