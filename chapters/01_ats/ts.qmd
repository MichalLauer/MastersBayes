...
mean function. Provided it exists, the mean function of time series is at time $t$ is defined by
...
To measure the depends of time series, autocovariance function offers a measure of linear dependence between two
...
if the mean function exists. The variance is also the same and the linear dependence, measure by covariance,
...
As an example, figure @fig-intro-ts taken from \parencite[Fig. 1.1]{shumway_time_2017} shows some of these properties o
n real data.
