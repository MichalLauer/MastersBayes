...
a general joint distribution function \parencite[chapter 1.3]{shumway_time_2017} is defined as 
...
\parencite[definition 1.1]{shumway_time_2017} as 
...
different points $t$ and $s$. Such function is defined by \parencite[definition 1.2]{shumway_time_2017} as
...
for $c \in \mathbb{R}$ \parencite[definition 1.4]{shumway_time_2017}. Same distribution function at any point
$t$ implies that 
...
strictly stationar process, it is often sufficient to have a weakly stationary process. \parencite[Def. 1.7]{shumway_time_2017}
...
As an example, figure @fig-intro-ts taken from \parencite[Fig. 1.1]{shumway_time_2017} shows some of these properties 
on real data.

![Johnson & Johnson quarterly earnings per share, 84 quarters, 1960-I to 1980-IV \parencite{shumway_time_2017}](./img/intro-ts.png){#fig-intro-ts}
...
rigid statistical analysis \parencite[Chap. 1]{shumway_time_2017}.

Stationarity is one of the most important properties that in TSD analysis. As \parencite[Chap. 2.1]{tsay_analysis_2005}
...
\parencite[Chap. 2.5]{tsay_analysis_2005}. This model employs integration, where the data is transformed
...
described in \parencite{tsay_analysis_2005}.

[^station]: Generalized condition for $AR(p)$ process is defined in \parencite[Chap. 2.4.1]{tsay_analysis_2005}
...
markets \parencite[Chap. 3]{tsay_analysis_2005}. Models that can handle such time series are called Conditional 
