...
\parencite{Bollerslev1986_GeneralizedAutoregressiveConditional}, are
...
variances given in @eq-var-garch. In addition to the ARCH constrains, for the GARCH $\beta$ coefficients it must hold
