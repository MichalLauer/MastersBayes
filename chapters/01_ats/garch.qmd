...
more flexible and offer greater better long-term memory for forecasting \parencite{al-najjar_modelling_2016}. GARCH
...
The main difference is in $\sigma_t$, which is given by \parencite[Eq. 2]{al-najjar_modelling_2016} as
...
\parencite[Chap. 3.5]{al-tsay_analysis_2005}. 
...
available \parencite[Chap. 3.5]{al-tsay_analysis_2005}
...
extensions that might be appropriate in specific domains, are covered in \parencite{al-najjar_modelling_2016} or
\parencite{al-tsay_analysis_2005}.