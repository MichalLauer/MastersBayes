...
representing the natural variance logarithm. This is because variance can only be non-negative, and modeling the log
...
An autoregressive process describes the latent variable
...
model more flexible, and this can capture more complex relationships. The estimation of latent variable $h_t$ is
