...
distribution for each parameter \parencite[9.2.1]{McElreath2020_StatisticalRethinkingBayesian}. GS is often better in multidimensional models, where the full posterior distribution is unknown, but the conditional posteriors of parameters is known and values can be
