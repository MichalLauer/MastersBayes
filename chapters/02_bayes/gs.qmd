...
distribution for each parameter \parencite[9.2.1]{McElreath2020_StatisticalRethinkingBayesian}. GS is often better in multidimensional models, where the full posterior distribution is unknown, but the conditional posteriors of indivudiual  parameters is known 
...
where the conjugate is unkown and computer numerically, MHA is superior. However, they are not able to conclude that MHA is in general superior to GS in abstract multilevel modeling. There are also advanced
