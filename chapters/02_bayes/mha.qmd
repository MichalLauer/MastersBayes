...
the two conditional proposal distributions is equal to 1 and can be then excluded. In the case of asymmetrical proposal
...
generate stationary chains are where the transition probabilities between two states are proportional to the posterior
