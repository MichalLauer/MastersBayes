...
simulation methods have been developed to sample observations from a posterior distribution without the need to know
the explicit analytical solutions. These methods do not work with Bayes' theorem in @eq-bayes-eq but rather with its
kernel
