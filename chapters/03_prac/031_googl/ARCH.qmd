...
that 89% credible interval of $(0.09, 1.16)$ that is quite wide and allows both low and high values. Full
...
not proper. The 89% credible interval for all coefficients is $(0.06, 0.51)$ because higher values would
