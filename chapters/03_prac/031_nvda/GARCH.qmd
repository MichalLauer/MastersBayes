...
because it their limitations are very similar (although their interpretation is not). In total, 8 different
...
|CI_lower   |5.14        |5.11        |5.11        |5.12        |5.10        |5.06        |5.11        |5.10        |
|CI_upper   |9.70        |9.59        |9.64        |9.56        |9.47        |9.49        |9.52        |9.47        |
...
|CI_lower   |0.0002      |0.0002      |0.0001      |0.0001      |0.0001      |0.0001      |0.0001      |0.0001      |
|CI_upper   |0.0004      |0.0003      |0.0003      |0.0002      |0.0002      |0.0002      |0.0002      |0.0001      |
...
|CI_lower   |0.03        |0.02        |0.02        |0.02        |0.02        |0.01        |0.01        |0.01        |
|CI_upper   |0.29        |0.26        |0.22        |0.20        |0.18        |0.16        |0.15        |0.14        |

The expectation gradually decreases and the 89% PI changes from $(0.03, 0.29)$ to $(0.01, 0.14)$. The same
effect can be observed with other coefficients in Figure @fig-nvda-garch-post-beta1 and Table
@tab-nvda-garch-post-beta-i.

![NVDA/GARCH: Posterior distribution for $\beta_1$.](./img/nvda/garch/posterior_beta1.png){#fig-nvda-garch-post-beta1}

Table: NVDA/GARCH: Expected $\beta_i$ for all models. {#tab-nvda-garch-post-beta-i}
...
first model, the volatility sharply drops after just a few time points. The bottom middle model has considers lag of 8
...
capture the underlying volatility. The same conclusion can be drawn from comparison Table @nvda-arch-post-loo.

Table: NVDA/GARCH: Comparison of models using ELPD. {#nvda-garch-post-loo}
