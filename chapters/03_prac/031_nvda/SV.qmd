...
The red posterior distribution that describes degrees of freedom for the innovation is around 15 - 30 degrees . The
blue posterior for the latent variable's random shock is higher and centered around 35. Posteriors are described in
Table @tbl-nvda-sv-post-nu.
...
different. The results suggest that the model can capture large volatility with degrees of freedom around 30, a
