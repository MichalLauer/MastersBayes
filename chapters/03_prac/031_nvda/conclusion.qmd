Visual inspection provides a significant insight into the quality of estimated volatility to compare models. Comparing
...
fixed standard deviation also fits the data fairly well.